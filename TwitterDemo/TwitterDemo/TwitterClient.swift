...
class TwitterClient: BDBOAuth1RequestOperationManager {
    ...
    func openURL(url:NSURL) {
        self.fetchAccessTokenWithPath("oauth/access_token", method: "POST", requestToken: BDBOAuth1Credential(queryString: url.query!),
            success: { (credential:BDBOAuth1Credential!) -> Void in
    ...
    func tweet(message:String, callBack: (response:NSDictionary?, error:NSError?) -> ()) {
        ...
        TwitterClient.sharedInstance.POST("https://api.twitter.com/1.1/statuses/update.json", parameters: params,
            success: { (requestOperation:AFHTTPRequestOperation, response:AnyObject) -> Void in
    ...
    func retweet(id:String, callBack: (response:NSDictionary?, error:NSError?) -> ()) {
        TwitterClient.sharedInstance.POST("https://api.twitter.com/1.1/statuses/retweet/\(id).json", parameters: nil,
            success: { (requestOperation:AFHTTPRequestOperation, response:AnyObject) -> Void in
                callBack(response: response as? NSDictionary, error: nil)
            }, failure: { (requestOperation:AFHTTPRequestOperation?, error:NSError) -> Void in
                callBack(response: nil, error: error)
    ...
    func unretweet(id:String, callBack: (response:NSDictionary?, error:NSError?) -> ()) {
        TwitterClient.sharedInstance.GET("https://api.twitter.com/1.1/statuses/show/\(id).json?include_my_retweet=1", parameters: nil,
            success: { (reqOperation: AFHTTPRequestOperation, response: AnyObject) -> Void in
                if  let dic = response as? NSDictionary,
                current_user_retweet = dic["current_user_retweet"],
                retweet_id = current_user_retweet["id_str"]
                {
                    TwitterClient.sharedInstance.POST("https://api.twitter.com/1.1/statuses/destroy/\(retweet_id!).json", parameters: nil,
                        success: { (requestOperation:AFHTTPRequestOperation, response:AnyObject) -> Void in
                            callBack(response: response as? NSDictionary, error: nil)
                        },
                        failure: { (requestOperation:AFHTTPRequestOperation?, error:NSError) -> Void in
            ...
            failure: { (reqOperation: AFHTTPRequestOperation?, error: NSError) -> Void in
                callBack(response: nil, error: error)
            }
        )
    }
    ...
    func favorite(id:String, callBack: (response:NSDictionary?, error:NSError?) -> ()) {
        ...
        TwitterClient.sharedInstance.POST("https://api.twitter.com/1.1/favorites/create.json", parameters: params,
            success: { (requestOperation:AFHTTPRequestOperation, response:AnyObject) -> Void in
                callBack(response: response as? NSDictionary, error: nil)
            },
            failure: { (requestOperation:AFHTTPRequestOperation?, error:NSError) -> Void in
    ...
    func unfavorite(id:String, callBack: (response:NSDictionary?, error:NSError?) -> ()) {
        ...
        TwitterClient.sharedInstance.POST("https://api.twitter.com/1.1/favorites/destroy.json", parameters: params,
            success: { (requestOperation:AFHTTPRequestOperation, response:AnyObject) -> Void in
                callBack(response: response as? NSDictionary, error: nil)
            },
            failure: { (requestOperation:AFHTTPRequestOperation?, error:NSError) -> Void in
